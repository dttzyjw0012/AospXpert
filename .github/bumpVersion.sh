...
sed -i 's/"zipUrl":.*/"zipUrl": "https:\/\/github.com\/siavash79\/AospXpert\/releases\/download\/'$GITHUB_REF_NAME'\/AospXpert.zip",/' MagiskModuleUpdate.json
#Full
...
sed -i 's/"zipUrl":.*/"zipUrl": "https:\/\/github.com\/siavash79\/AospXpert\/releases\/download\/'$GITHUB_REF_NAME'\/AospXpert.zip",/' MagiskModuleUpdate_Full.json
#Xposed
...
sed -i 's/"zipUrl":.*/"zipUrl": "https:\/\/github.com\/siavash79\/AospXpert\/releases\/download\/'$GITHUB_REF_NAME'\/AospXpert.zip",/' MagiskModuleUpdate_Xposed.json
#In-app updater
sed -i 's/"version":.*/"version": "'$NEWVERNAME'",/' latestStable.json
sed -i 's/"versionCode":.*/"versionCode": '$NEWVERCODE',/' latestStable.json
sed -i 's/"zipUrl_Full":.*/"zipUrl_Full": "https:\/\/github.com\/siavash79\/AospXpert\/releases\/download\/'$GITHUB_REF_NAME'\/AospXpert.zip",/' latestStable.json
sed -i 's/"zipUrl_Xposed":.*/"zipUrl_Xposed": "https:\/\/github.com\/siavash79\/AospXpert\/releases\/download\/'$GITHUB_REF_NAME'\/AospXpert.zip"/' latestStable.json
