...
import static com.yhc.aospxpert.ui.Constants.UPDATE_DOWNLOADED_ID;
import static com.yhc.aospxpert.ui.Constants.UPDATE_DOWNLOAD_FAILED_ID;
import static com.yhc.aospxpert.utils.AppUtils.installDoubleZip;
import static com.yhc.aospxpert.utils.MiscUtils.getColorFromAttribute;
import static com.yhc.aospxpert.utils.MiscUtils.intToHex;
...
import com.yhc.aospxpert.databinding.UpdateFragmentBinding;
...
public class UpdateFragment extends BaseFragment {
	public static final String MOD_NAME = "AospXpert";
	...
	private static final String stableUpdatesURL = "https://raw.githubusercontent.com/siavash79/AospXpert/stable/latestStable.json";
	private static final String canaryUpdatesURL = "https://raw.githubusercontent.com/siavash79/AospXpert/canary/latestCanary.json";
...
/*    private void getChangelog(String URL, TaskDoneCallback callback) {
	...
	public void startDownload(String zipURL, int versionNumber) {
		...
		downloadID = downloadManager.enqueue(new DownloadManager.Request(Uri.parse(zipURL))
				.setTitle("AospXpert Update Package")
				.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, String.format("AospXpert-%s.zip", versionNumber))
