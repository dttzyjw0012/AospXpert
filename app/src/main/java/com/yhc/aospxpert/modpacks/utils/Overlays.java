...
import static com.yhc.aospxpert.modpacks.utils.toolkit.OverlayTools.getActiveOverlays;
...
import com.yhc.aospxpert.modpacks.XPrefs;
...
public class Overlays {
	...
	public void initOverlays() //If called from UI OR Xposed
	{
		...
		Overlays.put("QSLightThemeOverlay", new OverlayProp("com.yhc.aospxpert_QSTheme", false));
		Overlays.put("QSLightThemeBSTOverlay", new OverlayProp("com.yhc.aospxpert_QSTheme_BST", false));
		Overlays.put("QSDualToneOverlay", new OverlayProp("com.yhc.aospxpert_QSDualTone", false));
		...
		for (Field field : fileds) {
			try {
				...
				if (resources.getResourceName(resid).endsWith("OverlayEx") || resources.getResourceName(resid).endsWith("OverlayG")) {
					...
					Overlays.put(resources.getResourceName(resid).replace("com.yhc.aospxpert:array/", ""), new OverlayGroup(resources.getResourceName(resid), members));
				}
