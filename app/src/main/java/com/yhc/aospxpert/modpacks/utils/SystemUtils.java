	...
	private void setFlashInternal(boolean enabled, boolean animate) {
		...
		try {
			...
			if (BuildConfig.DEBUG) {
				log("AospXpert Error in setting flashlight");
				log(t);
			}
		}
	}
	...
	private WifiManager getWifiManager() {
		if(mWifiManager == null)
		{
			try
			{
				...
				if (BuildConfig.DEBUG) {
					log("AospXpert Error getting wifi manager");
					log(t);
				}
			}
		}
	...
	private ConnectivityManager getConnectivityManager() {
		if(mConnectivityManager == null)
		{
			try
			{
				...
				if (BuildConfig.DEBUG) {
					log("AospXpert Error getting connection manager");
					log(t);
				}
			}
		}
	...
	private PowerManager getPowerManager() {
		if(mPowerManager == null)
		{
			try {
				...
				if (BuildConfig.DEBUG) {
					log("AospXpert Error getting power manager");
					log(t);
				}
			}
		}
	...
	private AlarmManager getAlarmManager() {
		if(mAlarmManager == null)
		{
			try {
				...
				if (BuildConfig.DEBUG) {
					log("AospXpert Error getting alarm manager");
					log(t);
				}
			}
		}
	...
	private TelephonyManager getTelephonyManager() {
		if(mTelephonyManager == null)
		{
			try {
				...
				if (BuildConfig.DEBUG) {
					log("AospXpert Error getting telephony manager");
					log(t);
				}
			}
		}
	...
	private VibratorManager getVibrationManager()
	{
		if(mVibrationManager == null)
		{
			try {
				...
				if (BuildConfig.DEBUG) {
					log("AospXpert Error getting vibrator");
					log(t);
				}
			}
		}
	...
	private NetworkStatsManager getNetworkStatsManager()
	{
		if(mNetworkStatsManager == null)
		{
			try
			{
				...
				if (BuildConfig.DEBUG) {
					log("AospXpert Error getting network stats");
					log(t);
				}
			}
		}
