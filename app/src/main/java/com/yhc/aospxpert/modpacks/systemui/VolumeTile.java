...
import static com.yhc.aospxpert.modpacks.systemui.QSTileGrid.QSHapticEnabled;
...
import static com.yhc.aospxpert.modpacks.utils.SystemUtils.registerVolumeChangeListener;
import static com.yhc.aospxpert.modpacks.utils.SystemUtils.unregisterVolumeChangeListener;
...
import com.yhc.aospxpert.modpacks.utils.SystemUtils.ChangeListener;
import com.yhc.aospxpert.modpacks.utils.TilePercentageDrawable;
...
public class VolumeTile extends XposedModPack {
	...
	private static final String TARGET_SPEC = "custom(com.yhc.aospxpert/.service.tileServices.VolumeTileService)";
