...
import static com.yhc.aospxpert.modpacks.utils.toolkit.ObjectTools.addItemToCommaStringIfNotPresent;
import static com.yhc.aospxpert.modpacks.utils.toolkit.ObjectTools.removeItemFromCommaString;
	...
	private void updateWifiCell() {
		XPLauncher.enqueueProxyCommand(proxy -> {
			...
			try {
				...
				if (WifiCellEnabled) {
					providerModel = false;
					currentTiles = addItemToCommaStringIfNotPresent(currentTiles, "cell_AospXpert");
					currentTiles = addItemToCommaStringIfNotPresent(currentTiles, "wifi_AospXpert");

					currentTiles = removeItemFromCommaString(currentTiles, "internet");
				} else {
					providerModel = true;

					currentTiles = removeItemFromCommaString(currentTiles, "cell_AospXpert");
					currentTiles = removeItemFromCommaString(currentTiles, "wifi_AospXpert");
